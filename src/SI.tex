...
\title{SI for Museum specimens reveal butterfly size increases through time but divergent responses to temperature}
...
\caption{Details of butterfly species used in this study. Habitat and foodplant specialism status was split into two categories divided  specialists (S) and generalists (G). Numbers for each datasets are the post-filterring counts.}\\
\toprule
...
\\Figure S1: . Associations between cross-species predictors. A) Correlations between three principle predictors. B-D) Relationship between taxonomic Family and other species-level predictors. Families differ greatly in size, but otherwise there is an approximately even spread. 

\\
\includegraphics[width=\linewidth]{../figs/compare_coefs_across_datasets.png}
\\Figure S2: \includegraphics[width=\linewidth]{../figs/SI_corr_inTempLatYear.png}

\\
\includegraphics[width=\linewidth]{../figs/Corr_sample_size_trends_NHM.png}
\\Figure S3: Relationship between sample size, confidence of posterior estimate and identification of species-level trends in the NHM, LONDON dataset. Precision of posterior estimates was strongly related to the sample size for each species, but the identification of confident trends was less dependent on sample size. 

\includegraphics[width=\linewidth]{../figs/PredictorsFigure_Both_withlabels.png}
\\Figure S4: Main text Figure 4 with species labels. 
...
\\ Figure S6 NB Locations jittered to reduce overlap \\
