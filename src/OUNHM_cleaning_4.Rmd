...
```{r}
counties <- st_read("/Users/elsaheywood/Documents/Butterfly_Project_MBiol-main/data/vice-counties-master/vice-counties-master/12-mile/County_12mile_region.shp")
print(counties)

unitary <- st_read("/Users/elsaheywood/Documents/Butterfly_Project_MBiol-main/data/Counties_and_Unitary_Authorities_May_2023_UK_BGC_9070630924157476989/CTYUA_MAY_2023_UK_BGC.shp")
print(unitary)
...
write.csv(unitary_midpoints_clean, "unitary_authority_midpoints.csv", row.names = FALSE)
...
write.csv(county_midpoints_clean, "county_midpoints.csv", row.names = FALSE)
...
write_csv(combined_locations, "combined_midpoints.csv")
```

## Now combine this with OUNHM_data_temps and that with BroodTable and Names_table
# Read in data
```{r}
OUNHM_data_temps <- read_csv("OUNHM_data_temps.csv")
BroodTable <- read_xlsx("/Users/elsaheywood/Downloads/butterfly brood table.xlsx")
Names_table <- read_xlsx("/Users/elsaheywood/Desktop/names_table.xlsx")
...
```{r}
OUNHM_for_models
write_csv(OUNHM_for_models, "OUNHM_for_models.csv")
```
